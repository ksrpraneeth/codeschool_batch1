Note : All the following functionality and validations should be through Javascript only

1. Show current time and date at Last Login in the exact format shown in the image
2. On Click of user profile button show his phone number and Designation in a drop down
...
6. On click of NEXT button show all validations at once.
