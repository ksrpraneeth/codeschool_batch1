...
<html lang="en">
	...
	<body style="background-color: lightgray">
		...
		<div class="w-100 h-100 position-absolute main text-white m-0 d-flex">
			<!-- Sidebar -->
			<div
				class="sidebar p-0 overflow-auto h-100 position-fixed"
				id="sidebar"
			>
				<!-- logo -->
				<img
					class="logo px-4 mt-2 w-100"
			...
			<div class="body position-relative p-0" id="body">
				<!-- Header -->
				<div
					class="header w-100 text-white p-2 d-flex justify-content-between"
				>
					<!-- Left -->
					<div class="left d-flex">
						<!-- Header Logo -->
						<img
							class="headerlogo d-block d-sm-none"
						...
						<!-- Menu Btn -->
						<div
							class="menuBtn d-none d-md-flex align-items-center"
						>
							<svg
						...
						<!-- Mobile Menu Btn -->
						<div
							class="menuBtn d-flex d-md-none align-items-center"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="25"
					...
					<div class="right d-flex">
						...
						<button
							onclick="logout()"
							class="logout d-none d-md-flex p-2 text-white border-0"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="16"
				...
				<div class="content text-dark m-sm-3 bg-white">
					<!-- Title -->
					<div
						class="title align-items-center p-2 d-none d-sm-flex"
					...
					<!-- Points -->
					<div
						class="points m-sm-4 p-3 rounded-2"
					...
					<div class="formDiv p-2 m-4">
						<!-- Errors -->
						<div
							class="errors text-danger d-block errorsDiv"
						...
						>
							<!-- Transaction Type -->
							<div
								class="transcation_type row inputGroup bg-light py-2"
							>
								<div class="col-lg-2 col-md-3 col-sm-12">
									<p class="">
										Transcation Type<span
											class="text-danger"
											>*</span
										>
									</p>
								...
								<div class="col-lg-10 col-md-9 col-sm-12">
									<ul
										class="list-unstyled d-flex gap-0 gap-sm-2 flex-wrap"
									>
										<li>
							...
							<div class="row inputGroup align-items-center py-2">
								<div class="col-lg-2 col-md-3 col-sm-12">
									<p class="">
										Party Name<span class="text-danger"
											>*</span
										>
									</p>
								</div>
							...
							<!-- Bank IFSC Code -->
							<div
								class="row bg-light inputGroup align-items-center py-2"
							>
								<div class="col-lg-2 col-md-3 col-sm-12">
									<p class="">
								...
								<div
									class="col-lg-5 col-md-8 col-sm-12 d-flex flex-column"
								>
									...
									<div
										id="ifscErrorDiv"
										class="text-danger ms-1 mt-2 errorsDiv"
									></div>
								</div>
							</div>
							...
							<div class="row inputGroup align-items-center py-2">
								<div class="col-lg-2 col-md-3 col-sm-12">
									<p class="">
										Head of account<span class="text-danger"
											>*</span
										>
									</p>
								</div>
							...
							<div class="row inputGroup align-items-center py-2">
								...
								>
									<input
										...
										oninput="partyAmountChanged(this.value)"
										id="partyAmount"
									/>
									<p
										id="partyAmountInWords"
										class="m-0 fw-normal mt-1 mx-1"
									></p>
							...
							<div class="row inputGroup align-items-center py-2">
								...
								<div class="col-lg-5 col-md-8 col-sm-12 d-flex">
									...
									<button
										type="button"
										class="btn btn-primary ms-2 d-flex"
										onclick="addFiles()"
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
							...
							<div class="row inputGroup align-items-center py-2">
								...
								<div class="col-lg-5 col-md-8 col-sm-12">
									<i
										>Note: Documents of Cheque(Letter/G.O.
										etc) can be uploaded here.</i
									>
									<ul
										id="filesList"
										class="filesList list-group"
									></ul>
								</div>
							</div>
		...
		<!-- Loading -->
		<div
			class="loading position-fixed w-100 h-100 d-flex justify-content-center align-items-center bg-white"
			id="loading"
		>
		...
		<div
			id="mobileSidebarBg"
			onclick="toggleMobileSidebar()"
			class="mobileSidebarBg d-none d-md-none position-fixed w-100 h-100"
		></div>
	</body>
</html>
