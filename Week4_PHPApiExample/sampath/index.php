...
<body style="background-color: lightgray">
	...
	<div class="w-100 h-100 position-absolute main text-white m-0 d-flex">
		...
		<div class="sidebar p-0 overflow-auto h-100 position-fixed" id="sidebar">
			<!-- logo -->
			<img class="logo px-4 mt-2 w-100"
				src="https://d20exy1ygbh3sg.cloudfront.net/fms/images/newUi/ifmis-logo.png" alt="" />
			<hr class="my-3" />
		...
		<div class="body position-relative p-0" id="body">
			...
			<div class="header w-100 text-white p-2 d-flex justify-content-between">
				...
				<div class="left d-flex">
					<!-- Header Logo -->
					<img class="headerlogo d-block d-sm-none" src="https://ifmis.telangana.gov.in/images/govt_logo.png"
						alt="" />

					<!-- Menu Btn -->
					<div class="menuBtn d-none d-md-flex align-items-center">
						<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
							class="bi bi-list" viewBox="0 0 16 16" style="cursor: pointer" onclick="toggleSidebar();">
					...
					<div class="menuBtn d-flex d-md-none align-items-center">
						<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
							class="bi bi-list" viewBox="0 0 16 16" style="cursor: pointer"
				...
				<div class="right d-flex">
					...
					<div role="button" data-bs-toggle="dropdown" aria-expanded="false"
						class="profile p-1 mx-0 mx-md-4 d-flex align-items-center dropdown-toggle">
						<!-- User logo -->
						<div class="left">
			...
			<div class="content text-dark m-sm-3 bg-white">
				<!-- Title -->
				<div class="title align-items-center p-2 d-none d-sm-flex"
				...
				<div class="formDiv p-2 m-4">
					<!-- Errors -->
					<div class="errors text-danger d-block errorsDiv" style="font-size: 12px" id="errors"></div>
					<!-- Form -->
					<form onsubmit="validateForm(event)" action="#" name="partyForm">
						...
						<div class="row inputGroup align-items-center py-2">
							...
							<div class="col-lg-5 col-md-8 col-sm-12">
								<input class="form-control" type="password" inputmode="numeric"
									placeholder="Enter A/C no" id="partyAccNum"
									oninput="this.classList.contains('is-invalid') ? hideError(this.id, 'partyAccNumErrors') : null" />
								<div id="partyAccNumErrors" class="errorsDiv text-danger mt-2 d-flex flex-column">
						...
						<div class="row inputGroup align-items-center py-2">
							...
							<div class="col-lg-5 col-md-8 col-sm-12">
								<input class="form-control" type="number" inputmode="numeric"
									oninput="this.classList.contains('is-invalid') ? hideError(this.id, 'conPartyAccNumErrors') : null"
									placeholder="Confirm A/C no" id="conPartyAccNum" />
								<div id="conPartyAccNumErrors" class="errorsDiv text-danger mt-2 d-flex flex-column">
								</div>
							</div>
						</div>
						...
						<div class="row inputGroup align-items-center py-2">
							...
							<div class="col-lg-5 col-md-8 col-sm-12">
								<input class="form-control" type="text" placeholder="Enter Party Name"
									oninput="this.classList.contains('is-invalid') ? hideError(this.id, 'partyNameErrors') : null"
									id="partyName" />
								<div id="partyNameErrors" class="errorsDiv text-danger mt-2 d-flex flex-column">
								</div>
							</div>
						</div>
						...
						<div class="row bg-light inputGroup align-items-center py-2">
							...
							<div class="col-lg-5 col-md-8 col-sm-12 d-flex flex-column">
								<div class="d-flex align-items-center">
									<input class="form-control" type="text" placeholder="Enter IFSC Code" id="IFSCCode"
										oninput="{
												this.value = this.value.toUpperCase();
												this.classList.contains('is-invalid') ? hideError(this.id, 'ifscErrorDiv') : null
												}" />
									<button type="button" onclick="ifscCodeChanged()" class="btn btn-primary ms-2">
										Search
									</button>
								</div>
								<div id="ifscErrorDiv" class="text-danger ms-1 mt-2 errorsDiv"></div>
							</div>
						</div>
						...
						<div class="row bg-light inputGroup align-items-center py-2">
							...
							<div class="col-lg-5 col-md-8 col-sm-12" id="bankName"></div>
						</div>
						...
						<div class="row bg-light inputGroup align-items-center py-2">
							...
							<div class="col-lg-5 col-md-8 col-sm-12" id="bankBranch"></div>
						</div>
						...
						<div class="row inputGroup align-items-center py-2">
							...
							<div class="col-lg-5 col-md-8 col-sm-12">
								<select name="" class="form-select" onchange="{
										this.classList.contains('is-invalid') ? hideError(this.id, 'headOfAccountErrors') : null;
										headOfAccountChanged(event, this)
										}" placeholder="Select" id="headOfAccount">
									<option class="d-none" value="">
										Select
									</option>
								</select>
								<div id="headOfAccountErrors" class="errorsDiv text-danger mt-2 d-flex flex-column">
								</div>
							</div>
						</div>
						...
						<div class="row inputGroup align-items-center py-2">
							...
							<div class="col-lg-5 col-md-8 col-sm-12">
								<select name="" class="form-select" placeholder="Select" onchange="{
									this.classList.contains('is-invalid') ? hideError(this.id, 'expenditureTypeErrors') : null;
									expenditureTypeChanged(this.value)
								}" id="expenditureType">
									<option class="d-none" value="">
										Select
									</option>
								</select>
								<div id="expenditureTypeErrors" class="errorsDiv text-danger mt-2 d-flex flex-column">
								</div>
							</div>
						</div>
						...
						<div class="row inputGroup align-items-center py-2">
							...
							<div class="col-lg-5 col-md-8 col-sm-12">
								<select name="" class="form-select" placeholder="Select"
									onchange="this.classList.contains('is-invalid') ? hideError(this.id, 'purposeTypeErrors') : null"
									id="purposeType">
									<option class="d-none" value="">
										Select
									</option>
								</select>
								<div id="purposeTypeErrors" class="errorsDiv text-danger mt-2 d-flex flex-column">
								</div>
							</div>
						</div>
						...
						<div class="row inputGroup align-items-center py-2">
							...
							<div class="col-lg-5 col-md-8 col-sm-12">
								<textarea class="form-control" placeholder="Purpose"
									oninput="this.classList.contains('is-invalid') ? hideError(this.id, 'purposeErrors') : null"
									id="purpose"></textarea>
								<div id="purposeErrors" class="errorsDiv text-danger mt-2 d-flex flex-column">
								</div>
							</div>
						</div>
						...
						<div class="row inputGroup align-items-center py-2">
							...
							<div class="col-lg-5 col-md-8 col-sm-12 d-flex flex-column">
								<input class="form-control" type="number" inputmode="numeric"
									...
									oninput="{
										this.classList.contains('is-invalid') ? hideError(this.id, 'partyAmountErrors') : null;
										partyAmountChanged(this.value)
									}"
									id="partyAmount" />
								<p id="partyAmountInWords" class="m-0 fw-normal mt-1 mx-1"></p>
								<div id="partyAmountErrors" class="errorsDiv text-danger mt-2 d-flex flex-column">
								</div>
							</div>
	...
	<!-- Loading -->
	<div class="loading position-fixed w-100 h-100 d-flex justify-content-center align-items-center bg-white"
		id="loading">
		<img src="./images/loading.gif" alt="" style="width: 250px" />
	</div>

	<!-- Mobile Sidebar Background -->
	<div id="mobileSidebarBg" onclick="toggleMobileSidebar()"
		class="mobileSidebarBg d-none d-md-none position-fixed w-100 h-100"></div>
</body>
