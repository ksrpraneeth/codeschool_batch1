...
CREATE TABLE Booking_Details(
    ...
    Guest_ID VARCHAR(25) REFERENCES Guest_Detials(Guest_ID),
    Room_No VARCHAR(40) REFERENCES Room_Type(Room_No),
    Staff_ID VARCHAR(25) REFERENCES Staff_Details(Staff_ID),
    Arrival_Date DATE,
    Departurte_Date DATE,
    Payment_ID VARCHAR(25) REFERENCES Payment_Details(Payment_ID)
);
...
CREATE TABLE Staff_Details(
    ...
    staf_Contact_Number VARCHAR(30),
    Staff_EmailID VARCHAR(25)
);
...
CREATE TABLE Guest_Detials(
    Guest_ID VARCHAR(25) PRIMARY KEY,
    Guest_First_Name VARCHAR(25),
    Guest_Last_Name VARCHAR(25),
    Guest_Gender VARCHAR(25),
    Guest_ID_Proof VARCHAR(25),
