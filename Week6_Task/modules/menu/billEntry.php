        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="filterDiv">
                            ...
                            <div class="filters d-flex gap-3 my-3">
                                <div class="form-check">
                                    <input
                                        onclick="window.empSearchFilterClass.setFilter('billId')"
                                        value="billId"
                                ...
                                <div class="form-check">
                                    <input
                                        onclick="window.empSearchFilterClass.setFilter('empCode')"
                                        value="empCode"
                                        class="form-check-input"
                                        type="radio"
                                        name="billIdFilter"
                                ...
                                <div class="form-check">
                                    <input
                                        onclick="window.empSearchFilterClass.setFilter('bankAcNo')"
                                        value="bankAcNo"
                                        class="form-check-input"
                                        type="radio"
                                        name="billIdFilter"
                            ...
                            >
                                ...
                                <div class="input">
                                    <select
                                        ...
                                        id="billId"
                                        class="form-select"
                                        onchange="window.empSearchFilterClass.setBillId(this.value)"
                                    ></select>
                                </div>
                            </div>
                    ...
                    <div id="detailsDiv" class="d-none mt-3">
                        ...
                        <div id="billMonthYearDiv" class="">
                            <div class="billMonthYear">
                                ...
                                <input
                                    ...
                                    id="monthAndYear"
                                    class="form-control"
                                    onchange="window.MonthAndYearClass.setMonthAndYear()"
                                />
                            </div>
                        </div>
                        ...
                        <div id="earningsDiv" class="mt-3">
                            <div class="earningsInputDiv">
                                ...
                                <div
                                    class="earningAmountDiv mt-2 row m-0 col-12 col-md-6 col-md-8 gap-1"
                                >
                                    <div class="col-9 p-0">
                                        <input
                                            type="text"
                                    ...
                                    <button
                                        ...
                                        onclick="window.earningsClass.addEarning()"
                                    >
                                        Add
                                    </button>
                                </div>
                                <div
                                    id="earningsTable"
                                    class="col-12 col-md-8 col-lg-6 mt-3"
                                >
                        ...
                        <div id="deductionsDiv" class="mt-3">
                            <div class="deductionsInputDiv">
                                ...
                                <div
                                    class="deductionAmountDiv row mt-2 m-0 col-12 col-md-6 col-md-8 gap-1"
                                >
                                    <div class="col-9 p-0">
                                        <input
                                            type="text"
                                    ...
                                    <button
                                        class="btn btn-success col-2"
                                        onclick="window.earningsClass.addDeduction()"
                                    >
                                        Add
                                    </button>
                                </div>
                    ...
                    <div id="mainErorr" class="text-danger"></div>
                </div>
